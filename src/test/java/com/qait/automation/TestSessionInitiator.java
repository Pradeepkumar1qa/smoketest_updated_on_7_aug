...
import com.qait.acs.keywords.QainfotechHomePage;
...
public class TestSessionInitiator {
  ...
  public QainfotechHomePage qainfotechhomepage;
  ...
  private void _initPage() {
	 // testPage = new TestPageActions(driver);
	qainfotechhomepage =new QainfotechHomePage(driver);
  }
